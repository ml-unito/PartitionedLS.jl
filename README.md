...
- an $\alpha$ variable for each feature, with the constraint that the set of $\alpha$ variables corresponding to a given group will be all positive and sum to $1$.
